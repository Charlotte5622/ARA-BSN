...
class SIDD_val(DenoiseDataSet):
    ...
    def _scan(self):
        ...
        clean_mat_file_path = os.path.join(dataset_path, 'SIDD_Validation/ValidationGtBlocksSrgb.mat')
        noisy_mat_file_path = os.path.join(dataset_path, 'SIDD_Validation/ValidationNoisyBlocksSrgb.mat')
...
class SIDD_benchmark(DenoiseDataSet):
    ...
    def _scan(self):
        mat_file_path = os.path.join(self.dataset_dir, 'SIDD/SIDD_benchmark/BenchmarkNoisyBlocksSrgb.mat')
        if not os.path.exists(mat_file_path):  # fallback: existing checkout outside this repository
            mat_file_path = '/home/trui/MyCodes/AP-BSN-master/dataset/SIDD/SIDD_benchmark/BenchmarkNoisyBlocksSrgb.mat'
